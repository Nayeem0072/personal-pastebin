...
const styles: Record<string, React.CSSProperties> = {
  default: { background: "var(--color-hover-overlay)", color: "var(--color-ink-2)", border: "1px solid var(--color-border)" },
  orange:  { background: "var(--color-blue-dim)",      color: "var(--color-blue)",   border: "1px solid var(--color-blue-glow)" },
  green:   { background: "var(--color-green-dim)",     color: "var(--color-green)",  border: "1px solid rgba(74,222,128,0.2)" },
