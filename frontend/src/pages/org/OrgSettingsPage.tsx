...
export default function OrgSettingsPage() {
  ...
  return (
    <div style={{ maxWidth: 560, margin: "0 auto", display: "flex", flexDirection: "column", gap: 40 }}>
      <h1 style={{ fontSize: 22, fontWeight: 700, color: "var(--color-ink)", margin: 0 }}>Organization Settings</h1>
      ...
      <Modal open={deleteOpen} onClose={() => setDeleteOpen(false)} title="Delete Organization">
        <p style={{ fontSize: 13, color: "var(--color-ink-2)", marginBottom: 20, lineHeight: 1.6 }}>
          Are you sure you want to delete <strong style={{ color: "var(--color-ink)" }}>{data?.org.name}</strong>? This cannot be undone.
        </p>
